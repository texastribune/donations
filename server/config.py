...
EXTERNAL_REDIRECTS = {
    ...
    "waco": {
        "/": "https://give.wacobridge.org/campaign/819605/donate?c_src=redirect&c_src2=legacy",
        "/donate": "https://give.wacobridge.org/campaign/819605/donate?c_src=redirect&c_src2=legacy",
        "/business": "https://give.wacobridge.org/campaign/819021/donate?c_src=redirect&c_src2=legacy",
    },
}
...
STRIPE_PRODUCTS = {
    ...
    "busnSmallMonthly": os.getenv("STRIPE_PRODUCT_BUSINESS_SMALL", ""),
    "busnSmallYearly": os.getenv("STRIPE_PRODUCT_BUSINESS_SMALL", ""),
    "busnMediumMonthly": os.getenv("STRIPE_PRODUCT_BUSINESS_MEDIUM", ""),
    "busnMediumYearly": os.getenv("STRIPE_PRODUCT_BUSINESS_MEDIUM", ""),
    "busnLargeMonthly": os.getenv("STRIPE_PRODUCT_BUSINESS_LARGE", ""),
    "busnLargeYearly": os.getenv("STRIPE_PRODUCT_BUSINESS_LARGE", ""),
